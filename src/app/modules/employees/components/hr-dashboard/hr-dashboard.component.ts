  ...
  template: `
    <div class="min-h-screen bg-gray-50/50">
      <div class="p-6">
        <!-- Header -->
        <div class="mb-8">
          <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Tableau de Bord RH</h1>
          <p class="text-gray-600 dark:text-gray-300">Vue d'ensemble de la gestion des ressources humaines</p>
        </div>
        ...
        <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4 mb-8">
          ...
          <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 class="text-xl font-bold text-gray-700 mb-2">{{employees.length}}</h3>
          ...
          <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-lg transition-shadow duration-300">
            <div class="flex items-center justify-between mb-4">
              ...
              <span class="text-sm font-medium text-purple-500 bg-purple-50 px-2.5 py-0.5 rounded-full">
                {{uniqueDepartments.length}} actifs
              </span>
            </div>
            <h3 class="text-xl font-bold text-gray-700 mb-2">{{uniqueDepartments.length}}</h3>
            <p class="text-gray-500 text-sm">Départements</p>
          </div>
          ...
          <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 class="text-xl font-bold text-gray-700 mb-2">{{activeEmployees}}</h3>
          ...
          <div class="bg-white rounded-xl shadow-sm p-6 hover:shadow-lg transition-shadow duration-300">
            ...
            <h3 class="text-xl font-bold text-gray-700 mb-2">{{inactiveEmployees}}</h3>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          ...
          <div class="bg-white rounded-xl shadow-sm p-6">
            <h3 class="text-lg font-semibold text-gray-700 mb-4">Distribution par Statut</h3>
            <div class="h-[300px]">
        ...
        <div class="bg-white rounded-xl shadow-sm p-6">
          <div class="flex justify-between items-center mb-6">
            <h3 class="text-lg font-semibold text-gray-700">Liste des Employés</h3>
            <button pButton 
